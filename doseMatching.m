...
if onehotencode==0                                                  %Mah. dist works for only cont. var(s)
    controlDataTemp = vis1ControlData;                            	
...
saveas(gcf,'treated Visit1.jpg')
multihist(V1data_UnmatchedControl); 
saveas(gcf,'unmatched control Visit1.jpg')
multihist(V1data_MatchedControl_e)
saveas(gcf,'matched control euc Visit1.jpg')
multihist(V1data_MatchedControl_p)
saveas(gcf,'matched control prop Visit1.jpg')
